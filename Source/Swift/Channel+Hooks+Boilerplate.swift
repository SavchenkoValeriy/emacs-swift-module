...
extension Channel {
    ...
    -> (T) -> Void
  {
    return { [self] arg in
      register {
        env in try env.funcall("run-hook-with-args", with: Symbol(name: hook), arg)
      }
    }
  }
  /// Make a Swift callback out of an Emacs hook's name.
  ...
  public func hook<T1: EmacsConvertible, T2: EmacsConvertible>(
    ...
    return { [self] (arg1, arg2) in
      register {
        env in try env.funcall("run-hook-with-args", with: Symbol(name: hook), arg1, arg2)
      }
    }
  }
  /// Make a Swift callback out of an Emacs hook's name.
  ...
  >(
    ...
    return { [self] (arg1, arg2, arg3) in
      register {
        env in try env.funcall("run-hook-with-args", with: Symbol(name: hook), arg1, arg2, arg3)
      }
    }
  }
  /// Make a Swift callback out of an Emacs hook's name.
  ...
  >(
    ...
    return { [self] (arg1, arg2, arg3, arg4) in
      register {
        env in try env.funcall("run-hook-with-args", with: Symbol(name: hook), arg1, arg2, arg3, arg4)
      }
    }
  }
  /// Make a Swift callback out of an Emacs hook's name.
  ...
  >(
    ...
    return { [self] (arg1, arg2, arg3, arg4, arg5) in
      register {
        env in try env.funcall("run-hook-with-args", with: Symbol(name: hook), arg1, arg2, arg3, arg4, arg5)
      }
    }
  }
}
